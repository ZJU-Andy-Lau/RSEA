...
from criterion_0926 import CriterionTrainOneImg,CriterionTrainElement,CriterionTrainGrid
...
class Element():
    ...
    def __extract_features__(self) -> Dict[str,torch.Tensor]:
        ...
        dems_Nhw = downsample(dems_NHW,self.encoder.SAMPLE_FACTOR,use_cuda=True,show_detail=bool(self.verbose),mode='avg',device=self.device)
